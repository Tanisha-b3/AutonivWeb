...
const plans = [
  ...
  },
  {
    ...
    callsPerMonth: 1000,
    badge: null,
    features: ['3 chatbots', '1,000 conversations/mo', 'WhatsApp + website', 'Hindi & Hinglish support'],
  },
  {
    id: 'growth',
    name: 'Growth',
    ...
    callsPerMonth: 5000,
    badge: 'Most Popular',
    features: ['10 chatbots', '5,000 conversations/mo', 'All channels incl. Instagram', 'CRM & helpdesk integrations'],
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
