                            ...
                            <a href={`https://wa.me/${CONTACT_PHONE_RAW}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 w-full px-4 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10 hover:border-white/20 transition-all group no-underline">
                              <div className="w-8 h-8 rounded-lg bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                                <svg className="w-4 h-4 text-emerald-400" fill="currentColor" viewBox="0 0 24 24">
                                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5 -.669-.51 -.173 -.008 -.371 -.01 -.57 -.01 -.198 0 -.52 .074 -.792 .372 -.272 .297 -1.04 1.0１６ -１．０４ ２．４７９ ０ １．４６２ １．０６５ ２．８７５ １．２１３ ３．０７４ .１４９ .１９８ ２．０９６ ３．２ ５．０７７ ４．４８７ .７０９ .３０６ １．２６２ .４８９ １．６９４ .６２５ .７１２ .２２７ １．３６ .１９５ １．８７１ .１１８ .５７１ -.０８５ １．７５８ -.７１９ ２．００６ -₁．４₁₃ .₂₄₈ -₀．₆₉₄ .₂₄₈ -₁．₂₈₉ .₁₇₃ -₁．₄₁₃ -.₀₇₄ -₀．₁₂₄ -.₂₇₂ -₀．₁₉₈ -.５七十 -₀．³⁴⁷ .⁴⁴⁶ -₀．⁵² .¹⁴⁹ -₀．¹⁷⁴ .¹⁹⁸ -₀．²⁹⁸ .²⁹⁸ -₀．⁴⁹⁷ .₀⁹⁹ -₀．¹⁹⁸ .₀伍 -₀．³⁷¹ -.₀²伍 -₀．⁵² -.₀七伍 -₀．¹四九 -.六六九 -₁．六¹² -.九¹六 -₂．²〇七 -.二四二 -₀．五七九 -.四八七 -₀．五 -.六六九 -₀．五壹 -.一七三 -₀．零零八 -.三七一 -₀．零一 -.五七 -₀．零一 -.一九八 〇 -.五二 〇 /.七九二 ".³七二 ".二七二 ".²九七 "⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."⁻¹."
                                </svg>
                              </div>
                              <div className="flex-1 min-w-0">
